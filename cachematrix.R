...
## functions do
## There are two funtions below. They are - "makeCacheMatrix" and "cacheSolve".
## These pair of funtions cache the inverse of a matrix.
...
## Write a short comment describing this function
## The funtion "cacheSolve" computes the inverse of the special "matrix"  
